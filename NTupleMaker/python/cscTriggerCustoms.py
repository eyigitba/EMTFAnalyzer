...
def addCSCTriggerRun3(process):
    ...
    process.simCscTriggerPrimitiveDigis.commonParam.runCCLUT_OTMB = False
    ...
    process.simCscTriggerPrimitiveDigisILT.commonParam.runCCLUT_OTMB = False
    ...
    process.simCscTriggerPrimitiveDigisRun3CCLUT.commonParam.runCCLUT_OTMB = True
    ...
    process.simCscTriggerPrimitiveDigisRun3CCLUTILT.commonParam.runCCLUT_OTMB = True
