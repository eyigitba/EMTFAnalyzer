...
config.General.requestName = 'SingleMuFlatOneOverPt1To1000GeV_Ntuple_fixed__posEndcap_v1'
config.General.workArea = 'logs'
config.General.transferLogs = True
config.General.transferOutputs = True

config.JobType.pluginName = 'PrivateMC' #'Analysis' #(If youhave an input dataset)
config.JobType.psetName = 'EMTFAnalyzer/NTupleMaker/test/SingleMuFlatOneOverPt1To1000GeV_GEN_SIM_DIGI_Ntuple_pos.py'
