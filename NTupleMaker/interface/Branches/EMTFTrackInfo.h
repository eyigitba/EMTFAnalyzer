...
struct EMTFTrackInfo {
  ...
  std::vector<TString> vFlt = {{"trk_pt", "trk_ptUnc", "trk_d0", "trk_eta", "trk_theta", "trk_phi", "trk_phi_loc", 
                                "trk_dR_match_dEta", "trk_dR_match_dPhi", "trk_dR_match_dR",
				"trk_unp_match_dEta", "trk_unp_match_dPhi", "trk_unp_match_dR"}};
  std::vector<TString> vInt = {{"trk_pt_int", "trk_ptUnc_int", "trk_d0_int", "trk_eta_int", "trk_theta_int", "trk_phi_int", "trk_BX", "trk_endcap", 
